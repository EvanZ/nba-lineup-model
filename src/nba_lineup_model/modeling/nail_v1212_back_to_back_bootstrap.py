"""Paired-bootstrap non-promotion gate for the NAIL B2B schedule control."""
...
DEFAULT_OUTPUT_ROOT = Path(
    "artifacts/models/nail_v1212_back_to_back_bootstrap/2023-24_to_2025-26"
)


def run_nail_v1212_back_to_back_bootstrap(
    *,
    ...
    """Test the B2B candidate against its standard-USG% parent branch."""
    ...
    run_id = (
        "nail-v1212-back-to-back-bootstrap-"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Bootstrap NAIL-RAPM v1.2.1.2 B2B schedule-control candidate"
    )
    parser.add_argument("--draws", type=int, default=DEFAULT_DRAWS)
    parser.add_argument("--seed", type=int, default=DEFAULT_SEED)
    args = parser.parse_args()
    run_dir = run_nail_v1212_back_to_back_bootstrap(draws=args.draws, seed=args.seed)
    print(f"NAIL-RAPM v1.2.1.2 B2B bootstrap: run={run_dir}")
