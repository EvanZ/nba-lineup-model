"""Paired-bootstrap gate for the prior teammate-continuity candidate."""
...
DEFAULT_BACKTEST_ROOT = Path(
    "artifacts/models/nail_teammate_continuity_frozen_backtest/"
    "frozen_multiseason_backtest/2023-24_to_2025-26"
)
DEFAULT_OUTPUT_ROOT = Path(
    "artifacts/models/nail_teammate_continuity_bootstrap/2023-24_to_2025-26"
)


def run_nail_teammate_continuity_bootstrap(
    *,
    ...
    run_id = (
        "nail-teammate-continuity-bootstrap-"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Bootstrap teammate-continuity candidate")
    parser.add_argument("--draws", type=int, default=DEFAULT_DRAWS)
    parser.add_argument("--seed", type=int, default=DEFAULT_SEED)
    args = parser.parse_args()
    run_dir = run_nail_teammate_continuity_bootstrap(draws=args.draws, seed=args.seed)
    print(f"NAIL teammate-continuity bootstrap: run={run_dir}")
