"""Paired-bootstrap gate for the teammate-continuity replacement candidate."""
...
DEFAULT_BACKTEST_ROOT = Path(
    "artifacts/models/nail_teammate_continuity_replacement_frozen_backtest/"
    "frozen_multiseason_backtest/2023-24_to_2025-26"
)
DEFAULT_OUTPUT_ROOT = Path(
    "artifacts/models/nail_teammate_continuity_replacement_bootstrap/2023-24_to_2025-26"
)


def run_nail_teammate_continuity_replacement_bootstrap(
    *,
    ...
    run_id = (
        "nail-teammate-continuity-replacement-bootstrap-"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Bootstrap the teammate-continuity replacement candidate"
    )
    parser.add_argument("--draws", type=int, default=DEFAULT_DRAWS)
    parser.add_argument("--seed", type=int, default=DEFAULT_SEED)
    args = parser.parse_args()
    run_dir = run_nail_teammate_continuity_replacement_bootstrap(
        draws=args.draws,
        seed=args.seed,
    )
    print(f"NAIL continuity-replacement bootstrap: run={run_dir}")
