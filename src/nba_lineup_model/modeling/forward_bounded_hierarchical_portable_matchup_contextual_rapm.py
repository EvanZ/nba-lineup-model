"""Bounded hierarchical portable-matchup contextual RAPM."""
...
MODEL_NAME = "forward_bounded_hierarchical_portable_matchup_contextual_rapm"
RUN_PREFIX = "forward-bounded-hierarchical-portable-matchup-contextual-rapm"


def train_forward_bounded_hierarchical_portable_matchup_contextual_rapm(
    *,
    ...
    """Roll bounded portable context forward across all available seasons."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train bounded hierarchical portable-matchup contextual RAPM"
    )
    parser.add_argument("--through-season", default=DEFAULT_TARGET_SEASON)
    args = parser.parse_args()
    run = train_forward_bounded_hierarchical_portable_matchup_contextual_rapm(
        through_season=args.through_season
    )
    print(f"Forward bounded hierarchical portable-matchup contextual RAPM: run={run.run_dir}")
