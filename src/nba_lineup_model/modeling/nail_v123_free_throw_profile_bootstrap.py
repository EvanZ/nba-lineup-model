"""Paired-bootstrap non-promotion gate for NAIL-RAPM v1.2.3."""
...
DEFAULT_OUTPUT_ROOT = Path(
    "artifacts/models/nail_v123_free_throw_profile_bootstrap/2023-24_to_2025-26"
)


def run_nail_v123_free_throw_profile_bootstrap(
    *,
    ...
    """Persist paired bootstrap evidence for the v1.2.3 FTA/100 ablation."""
    if draws < 1:
    ...
    run_id = (
        "nail-v123-free-throw-profile-bootstrap-"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Bootstrap NAIL-RAPM v1.2.3 FTA/100 ablation")
    parser.add_argument("--draws", type=int, default=DEFAULT_DRAWS)
    parser.add_argument("--seed", type=int, default=DEFAULT_SEED)
    args = parser.parse_args()
    run_dir = run_nail_v123_free_throw_profile_bootstrap(
        draws=args.draws,
        seed=args.seed,
    )
    print(f"NAIL-RAPM v1.2.3 bootstrap: run={run_dir}")
