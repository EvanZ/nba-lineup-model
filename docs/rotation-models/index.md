...
| [Forward Availability v0.2](forward-availability-v02.md) | Season medical-availability share | Exposure-shrunk first state; clears age-only frozen benchmark |
| [Forward Conditional Minutes v0.1](forward-conditional-minutes-v01.md) | Preseason minutes per available game | In development: aging and exposure-shrunk player state |
